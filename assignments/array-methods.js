...
runners.forEach(runner => fullName += runner['first_name'] + " " + runner['last_name'] + ", ")
...
let allCaps = [];
runners.map(runner => (allCaps += runner['first_name'].toUpperCase() + ", "));
console.log(allCaps); 
...
runners.filter(runner => ( (largeShirts += runner['shirt_size'] = 'L'  )))
console.log(largeShirts);

// ==== Challenge 4: Use .reduce() ====
// The donations need to be tallied up and reported for tax purposes. Add up all the donations into a ticketPriceTotal array and log the result
let ticketPriceTotal = [];
runners.reduce((total,donations) =>(  );

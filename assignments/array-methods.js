...
//                  or += didnt know what one was better to use.

// for(i = 0; i < runners.length; i++){
//     fullName = fullName + runners[i].first_name + " " + runners[i].last_name +", ";
// }
...
runners.filter(runner => {if (runner['donation'] < 100  ) {lessThan100.push(runner)}});
console.log(lessThan100);
// Problem 3

let doubleDonation = [];
runners.map(runner => (doubleDonation.push (runner['last_name'] + ", $" + runner['donation'] * 2  + ", ")));
console.log(doubleDonation); 